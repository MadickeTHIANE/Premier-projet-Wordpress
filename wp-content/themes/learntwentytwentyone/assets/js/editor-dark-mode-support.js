/* global learntwentytwentyoneIsDarkMode, setTimeout */

// Check the color scheme preference and inject the classes if necessary.
if ( document.body.classList.contains( 'learntwentytwentyone-supports-dark-theme' ) ) {
	learntwentytwentyoneDarkModeEditorInit();
}
 ...
 * @return {void}
 */
function learntwentytwentyoneDarkModeEditorInit( attempt ) {
	...
	if ( learntwentytwentyoneIsDarkMode() ) {
		if ( null === container ) {
			// Try again.
			if ( attempt < maxAttempts ) {
				setTimeout(
					function() {
						learntwentytwentyoneDarkModeEditorInit( attempt + 1 );
					},
