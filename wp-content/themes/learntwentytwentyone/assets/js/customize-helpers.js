 ...
 */
function learntwentytwentyoneGetHexLum( hex ) { // jshint ignore:line
	var rgb = learntwentytwentyoneGetRgbFromHex( hex );
 ...
 */
function learntwentytwentyoneGetRgbFromHex( hex ) {
